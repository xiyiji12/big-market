package com.wenying.domain.strategy.service.rule.filter.factory;
...
public class DefaultLogicFactory {
    ...
    public enum LogicModel {
        ...
        public static boolean isCenter(String code){//抽奖中
            return "center".equals(LogicModel.valueOf(code.toUpperCase()).type);
        }
        public static boolean isAfter(String code){//抽奖后
